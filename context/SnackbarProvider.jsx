    ...
    <SnackbarContext.Provider value={showSnackbar}>
      ...
      <div
        className={classNames(
          'transition-transform bottom-8 text-white left-8 fixed flex justify-between gap-2 items-center shadow-md min-h-[48px] max-w-[50vw] p-4 rounded-lg min-w-[300px] text-sm z-[1000]',
          {
